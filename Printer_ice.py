...
if 'PrinterPrx' not in _M_Demo.__dict__:
    ...
    class PrinterPrx(Ice.ObjectPrx):
        ...
        def reverseString(self, s, context=None):
            return _M_Demo.Printer._op_reverseString.invoke(self, ((s, ), context))

        def reverseStringAsync(self, s, context=None):
            return _M_Demo.Printer._op_reverseString.invokeAsync(self, ((s, ), context))

        def begin_reverseString(self, s, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Printer._op_reverseString.begin(self, ((s, ), _response, _ex, _sent, context))

        def end_reverseString(self, _r):
            return _M_Demo.Printer._op_reverseString.end(self, _r)

        def isPalindrome(self, s, context=None):
            return _M_Demo.Printer._op_isPalindrome.invoke(self, ((s, ), context))

        def isPalindromeAsync(self, s, context=None):
            return _M_Demo.Printer._op_isPalindrome.invokeAsync(self, ((s, ), context))

        def begin_isPalindrome(self, s, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Printer._op_isPalindrome.begin(self, ((s, ), _response, _ex, _sent, context))

        def end_isPalindrome(self, _r):
            return _M_Demo.Printer._op_isPalindrome.end(self, _r)
    ...
    class Printer(Ice.Object):
        ...
        def reverseString(self, s, current=None):
            raise NotImplementedError("servant method 'reverseString' not implemented")
    ...
    Printer._op_reverseString = IcePy.Operation('reverseString', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), IcePy._t_string, False, 0), ())
    Printer._op_isPalindrome = IcePy.Operation('isPalindrome', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), IcePy._t_bool, False, 0), ())
